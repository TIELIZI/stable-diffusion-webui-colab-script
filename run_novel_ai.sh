...
!mv /content/model/novelaileak/stableckpt/animevae.pt /content/drive/MyDrive/models/Stable-diffusion/final-pruned.vae.pt 
!mv /content/model/novelaileak/stableckpt/animefull-final-pruned/model.ckpt /content/drive/MyDrive/models/Stable-diffusion/final-pruned.ckpt
!mv /content/model/novelaileak/stableckpt/modules/modules/ /content/drive/MyDrive/models/hypernetworks
print("Success!")
