...
解决方案：<br>
1、google drive 共享文件<br>
https://drive.google.com/drive/folders/1-4MNEGjBt-GtVQEOIoKpejn1Q63eN2dZ?usp=sharing<br>
全选-右键添加快捷方式到云端硬盘-我的云端硬盘-新建models目录-选中models目录点击保存<br>

2、也可以执行以下代码，下载模型文件到 google drive 的 /models 目录（通过torrent下载，可能需要1小时或更长）<br>
